...
<body>
	...
	<div id="header-with-tabs">
		...
		<div class="page-full-width cf">
			...
			<!-- Change this image to your own company's logo111 -->
			<!-- The logo111 will automatically be resized to 30px height. -->
			<a href="#" id="company-branding-small" class="fr"><img src="<?php if(isset($_SESSION['logo111'])) { echo "upload/".$_SESSION['logo111'];}else{ echo "upload/logo111.png"; } ?>" alt="Point of Sale" /></a>
